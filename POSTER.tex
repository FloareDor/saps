...
\begin{column}{0.30\linewidth}
  ...
  \begin{block}{Results (LLaDA-8B, GSM8K)}
    ...
    \begin{tabular}{lccc}
      ...
      \midrule
      Vanilla LLaDA   & $\sim$0.145\,GiB & — & 72.7\% \\
    ...
    Less memory \emph{and} better accuracy.}
  \end{block}
  ...
  \begin{block}{Why Does Accuracy Improve?}
    ...
    \vspace{0.3em}
    SAPS also \textbf{outperforms vanilla} LLaDA by 5.5\,pp
    while using $\sim$66\% less KV memory.
  \end{block}
